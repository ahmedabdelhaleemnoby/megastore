...
ob_start();
session_start();
isset($_SESSION['username']) ? $_SESSION['username'] : header('location:login.php');
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        <li>
                            <a class="active" href="/megastore/admin/index.php"><span class="icon home" aria-hidden="true"></span>Dashboard</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="show-cat-btn" href="##">
                                <span class="icon image" aria-hidden="true"></span>sliders
                                <span class="category__btn transparent-btn" title="Open list">
                                    <span class="sr-only">Open list</span>
                                    <span class="icon arrow-down" aria-hidden="true"></span>
                                </span>
