    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div id="tab-1" class="tab-pane fade show p-0 active">
                ...
                <div class="row g-4">
                    <?php
                    $select_pro = mysqli_query($con, "SELECT * FROM product WHERE category= 1");
            ...
            <div id="tab-2" class="tab-pane fade show p-0">
                <div class="row g-4">
                    <?php
                    $select_pro = mysqli_query($con, "SELECT * FROM product WHERE category= 3");
            ...
            <div id="tab-3" class="tab-pane fade show p-0">
                <div class="row g-4">
                    <?php
                    $select_pro = mysqli_query($con, "SELECT * FROM product WHERE category= 4");
